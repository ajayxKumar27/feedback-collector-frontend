...
const HomePage: React.FC = () => {
  ...
  return (
    <div className={`bg-white shadow-2xl rounded-2xl p-6 w-full max-w-md border border-blue-100 relative ${isLoading ? 'pointer-events-none' : ''}`}>
      {isLoading && (
        <>
      ...
      <h1 className="text-3xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500 mb-6 drop-shadow">
        Submit Feedback
      </h1>
      <form onSubmit={handleSubmit} className="space-y-6 ">
        ...
        <input
          ...
          className="block w-full px-4 py-2 rounded-lg border border-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300 transition bg-white/80 mb-4"
          required
        />
        <input
          type="email"
        ...
        <textarea
          ...
          value={form.feedback}
          onChange={handleChange}
          className="block w-full px-4 py-2 rounded-lg border border-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-300 transition resize-none bg-white/80 mb-4"
          rows={4}
          required
        />
        <button
